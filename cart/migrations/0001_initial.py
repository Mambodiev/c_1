# Generated by Django 3.2 on 2021-10-11 03:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(help_text='this is place for the title of the product', max_length=150)),
                ('title_en', models.CharField(help_text='this is place for the title of the product', max_length=150, null=True)),
                ('title_fr', models.CharField(help_text='this is place for the title of the product', max_length=150, null=True)),
                ...
                ('product_detail', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True)),
                ('product_detail_en', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True)),
                ('product_detail_fr', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True)),
                ('specification', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True)),
                ('specification_en', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True)),
                ('specification_fr', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True)),
                ...
                ('primary_category_en', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='primary_products', to='cart.category')),
                ('primary_category_fr', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='primary_products', to='cart.category')),
